...
#[macro_export]
macro_rules! print  {
    ($($args:tt)*) => ($crate::print::global_print(format_args!($($args)*)));
}
...
#[macro_export]
macro_rules! info  {
    ($($args:tt)*) => ($crate::print!("[INFO]  {}:{:<3}: {}\n",
            file!(), line!(), format_args!($($args)*)));
}

#[macro_export]
macro_rules! warn  {
    ($($args:tt)*) => ($crate::print!("[WARN]  {}:{:<3}: {}\n",
            file!(), line!(), format_args!($($args)*)));
}

#[macro_export]
macro_rules! error  {
    ($($args:tt)*) => ($crate::print!("[ERROR] {}:{:<3}: {}\n",
            file!(), line!(), format_args!($($args)*)));
}
